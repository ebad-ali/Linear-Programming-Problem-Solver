 ...
 * @author Ebad
 */
public class NorthGUISHOW4 extends javax.swing.JFrame {
 public static Problem arrayme[][] = new Problem[Data.row][Data.column];

 
    public NorthGUISHOW4() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NorthGUISHOW4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               NorthGUISHOW4 gut =  new NorthGUISHOW4();
