 ...
 * @author Ebad
 */
public class Least extends javax.swing.JFrame {

    /**
     * Creates new form Least
     */
    public Least() {
        initComponents();
  ...
  jPanel1 = new javax.swing.JPanel();
    ...
    private void jTextField_columnActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (a.length() == 0 || b.length() == 0) {
            ...
            if (x == 3 && y == 4) {
                ...
                dispose();
                LeastGUI3 gu = new LeastGUI3();
                gu.setVisible(true);

            } else if (x == 3 && y == 3) {
                dispose();
                LeastGUI4 gu = new LeastGUI4();
                gu.setVisible(true);
    ...
    private void jTextField_columnKeyPressed(java.awt.event.KeyEvent evt) {
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Least.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
